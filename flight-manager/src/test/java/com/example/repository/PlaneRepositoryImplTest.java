...
class PlaneRepositoryImplTest {
    ...
    @Test
    public void unhappyPath_addPlane_shouldThrowPlaneException() {
        // given
        Integer planeRoute = 1, day = 1, maxPassengers = 10;
        planeRepository.addPlane(planeRoute, day, maxPassengers);
        // when && then
    ...
    @Test
    public void unhappyPath_cancelPlane_shouldThrowPlaneException() {
        // given
        Integer planeRoute = 1, day = 1, maxPassengers = 10;
        planeRepository.addPlane(planeRoute, day, maxPassengers);
        // when && then
    ...
    @Test
    public void unhappyPath_changePassengerAmountAndDay_shouldThrowPlaneException() {
        // given
        Integer planeRoute = 1, day = 1, maxPassengers = 10;
        planeRepository.addPlane(planeRoute, day, maxPassengers);
        // when && then
